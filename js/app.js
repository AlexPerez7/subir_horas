const API_BASE = 'https://asistente-vmware.tail8f4e31.ts.net';
...
async function verificarBackend(){
  ...
  _timeoutDespertando = setTimeout(() => {
    _setEstadoBackend('estado-conectando', 'Conectando...', 'El backend está tardando más de lo normal en responder.');
  }, 3000);
